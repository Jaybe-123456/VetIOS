...
import { BookOpenCheck, DatabaseZap, FileText, Loader2, SearchCheck } from 'lucide-react';
import {
    Container,
    DataRow,
    PageHeader,
    ...
    return (
        <Container className="max-w-[96rem]">
            ...
            <div className="mb-6 grid gap-3 md:grid-cols-4">
                ...
                <MetricTile icon={<SearchCheck className="h-4 w-4" />} label="Mode" value="Citation RAG" />
            </div>

    ...
    return (
        <section id="system" className="landing-section scroll-mt-28">
            <Reveal>
                ...
                <div className="mt-14 rounded-[32px] border border-white/10 bg-black/40 p-4 shadow-[0_28px_80px_rgba(0,0,0,0.35)] md:p-6">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {['case.input.json', 'runtime.trace', 'policy.guard'].map((tab, index) => (
                                        <div
                                            ...
                                            className={
                                                index === 0
                                                    ? 'rounded-full border border-[#38DCC6]/28 bg-[#38DCC6]/10 px-3 py-1.5 text-[11px] uppercase tracking-[0.18em] text-[#B9FFF0]'
                                                    : 'rounded-full border border-white/10 bg-white/[0.03] px-3 py-1.5 text-[11px] uppercase tracking-[0.18em] text-white/46'
                                            }
                                        >
                                            {tab}
                                        </div>
                            ...
                            <div className="grid gap-4 md:grid-cols-4">
                                {systemMetrics.map((metric) => (
                                    <div key={metric.label} className="rounded-[24px] border border-white/10 bg-white/[0.03] p-4">
                                        ...
                                        <div className="mt-3 text-xl font-medium tracking-[-0.03em] text-white">
                                            {metric.value}
                                        </div>
                                    </div>
                                ))}

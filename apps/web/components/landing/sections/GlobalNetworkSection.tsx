    ...
    return (
        <section className="landing-section">
            <Reveal>
                ...
                <Panel className="relative mt-14 overflow-hidden px-6 py-8 md:px-10 md:py-10">
                    ...
                    <div className="relative grid gap-8 lg:grid-cols-[1.15fr_0.85fr]">
                        <div className="relative min-h-[320px] overflow-hidden rounded-[28px] border border-white/8 bg-[#0C1117]">
                            <div className="landing-grid absolute inset-0 opacity-[0.16]" />
                            <svg viewBox="0 0 1200 460" className="absolute inset-0 h-full w-full opacity-85">
                                <defs>

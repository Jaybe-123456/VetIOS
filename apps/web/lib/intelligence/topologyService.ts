...
const MAX_TOPOLOGY_TELEMETRY_EVENTS = 200;
const MAX_TOPOLOGY_FALLBACK_TELEMETRY_EVENTS = 100;
const MAX_TOPOLOGY_WORKLOAD_EVENTS = 80;
const MAX_TOPOLOGY_OPERATIONAL_INFERENCE_EVENTS = 120;
const MAX_TOPOLOGY_OPERATIONAL_OUTCOME_EVENTS = 120;
const MAX_TOPOLOGY_CLINICAL_CASES = 300;
const MAX_TOPOLOGY_EVALUATION_EVENTS = 200;

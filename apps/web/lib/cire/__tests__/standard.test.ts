...
describe('CIRE public specification', () => {
    it('publishes a versioned public runtime signal contract', () => {
        ...
        expect(standard.operational_proof_url).toBe(`https://www.vetios.tech${CIRE_OPERATIONAL_PROOF_API_PATH}`);
    ...
    it('defines the runtime signals needed for external citation', () => {
        ...
        expect(standard.public_api_surfaces).toContain(CIRE_OPERATIONAL_PROOF_API_PATH);
    });
});

...
const SIGNAL_DEFINITIONS: ClinicalSignalDefinition[] = [
    ...
    },
    {
        ...
        domains: ['respiratory'],
        specificity: 'medium',
        aliases: ['runny nose', 'nasal discharge', 'clear nasal discharge', 'serous nasal discharge', 'nasal_discharge', 'nasal_discharge_serous', 'rhinitis'],
    },
    {
        ...
        domains: ['respiratory'],
        specificity: 'high',
        aliases: ['mucopurulent nasal discharge', 'mucopurulent discharge', 'green nasal discharge', 'yellow nasal discharge', 'nasal_discharge_mucopurulent', 'mucopurulent_nasal_discharge'],
    },
    {
    ...
    },
    {
        ...
        family: 'hypersalivation',
        domains: ['respiratory'],
        specificity: 'high',
        aliases: ['hypersalivation', 'drooling', 'drool', 'excessive salivation', 'salivating'],
    },
    {
        term: 'oral_ulceration',
        family: 'oral_ulceration',
        domains: ['respiratory'],
        specificity: 'high',
        aliases: ['oral ulceration', 'oral ulcers', 'mouth ulcers', 'tongue ulcers', 'oral_ulceration'],
    },
    {
        term: 'dyspnea',
        family: 'dyspnea',

...
function buildOutputPayload(
    ...
    return {
        ...
        species_validation: clinicalOutput?.species_validation ?? null,
        ...
        recommended_tests: clinicalOutput?.clinical_intelligence?.recommended_tests ?? [],
        outcome_learning_hooks: clinicalOutput?.clinical_intelligence?.outcome_learning_hooks ?? [],
        explainability_report: clinicalOutput?.explainability_report ?? [],
        causal_memory_update: clinicalOutput?.causal_memory_update ?? null,

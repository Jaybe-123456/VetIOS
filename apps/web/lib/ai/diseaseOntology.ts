...
export const ONTOLOGY_OBSERVATION_DICTIONARY: OntologyObservationDefinition[] = [
    ...
    { term: 'sneezing', aliases: ['sneeze', 'sneezing fits'], category: 'symptom' },
    { term: 'nasal_discharge', aliases: ['runny nose', 'snotty nose', 'rhinorrhea', 'serous nasal discharge', 'mucopurulent nasal discharge', 'nasal discharge mucopurulent', 'rhinitis'], category: 'symptom' },
    { term: 'ocular_discharge', aliases: ['eye discharge', 'watery eyes', 'eyes watery', 'conjunctival discharge'], category: 'symptom' },
    { term: 'conjunctivitis', aliases: ['pink eye', 'red eyes', 'inflamed conjunctiva'], category: 'exam' },
    { term: 'oral_ulceration', aliases: ['oral ulcers', 'mouth ulcers', 'tongue ulcers', 'ulcers in mouth'], category: 'exam' },
    ...
    { term: 'abnormal_lung_sounds', aliases: ['harsh lung sounds', 'increased lung sounds', 'crackles', 'wheezes', 'abnormal respiratory sounds'], category: 'exam' },
    ...
    { term: 'paresis', aliases: ['partial paralysis', 'hindlimb weakness', 'hind limb weakness', 'dragging hind legs', 'dragging hind limbs'], category: 'symptom' },
    ...
    { term: 'proprioceptive_deficits', aliases: ['knuckling', 'proprioceptive deficits'], category: 'symptom' },
    ...
    { term: 'spinal_pain', aliases: ['back pain', 'spinal pain', 'thoracolumbar pain'], category: 'symptom' },
    ...
    { term: 'thoracic_imaging_abnormality', aliases: ['thoracic imaging abnormalities', 'thoracic radiograph abnormal', 'lung infiltrates on radiographs', 'alveolar pattern', 'interstitial lung pattern'], category: 'exam' },
    { term: 'poor_oxygenation', aliases: ['hypoxemia', 'blood gas abnormality', 'poor oxygenation', 'low oxygen saturation'], category: 'lab' },
    { term: 'pulmonary_edema', aliases: ['fluid in lungs'], category: 'exam' },
    { term: 'pleural_effusion', aliases: ['fluid in chest'], category: 'exam' },
    { term: 'spinal_cord_deficits', aliases: ['spinal cord deficits'], category: 'exam' },
    { term: 'disc_extrusion', aliases: ['disc extrusion', 'intervertebral disc extrusion', 'extruded disc'], category: 'exam' },
...
export const MASTER_DISEASE_ONTOLOGY: DiseaseOntologyEntry[] = [
    ...
    },
    {
        ...
        key_clinical_features: [f('paresis', 0.26), f('paralysis', 0.28), f('proprioceptive_deficits', 0.22), f('disc_extrusion', 0.28)],
        supporting_features: [f('spinal_pain', 0.18), f('spinal_cord_deficits', 0.18), f('ataxia', 0.16), f('acute_onset', 0.08)],
    ...
    {
        id: 'feline-upper-respiratory-complex',
        name: 'Feline Upper Respiratory Disease Complex',
        aliases: ['FURDC', 'feline upper respiratory infection', 'feline upper respiratory syndrome', 'cat flu'],
        category: 'Cardiopulmonary',
        subcategory: 'Airway',
        condition_class: 'Infectious',
        key_clinical_features: [f('sneezing', 0.24), f('nasal_discharge', 0.22), f('conjunctivitis', 0.22)],
        supporting_features: [f('ocular_discharge', 0.16), f('oral_ulceration', 0.16), f('hypersalivation', 0.12), f('fever', 0.08), f('anorexia', 0.06), f('lethargy', 0.06)],
        exclusion_features: [f('dyspnea', 0.12), f('tachypnea', 0.12), f('abnormal_lung_sounds', 0.16), f('pneumonia', 0.18), f('thoracic_imaging_abnormality', 0.16), f('poor_oxygenation', 0.16)],
        lab_signatures: [],
        progression_pattern: ['acute', 'subacute'],
        species_relevance: ['cat'],
        zoonotic: false,
        minimum_feature_match_threshold: 3,
        minimum_key_feature_matches: 2,
    },
    {
        id: 'fhv-1-infection',
        name: 'FHV-1 Infection',
        aliases: ['Feline herpesvirus-1 infection', 'FHV-1', 'feline herpesvirus'],
        category: 'Cardiopulmonary',
        subcategory: 'Airway',
        condition_class: 'Infectious',
        key_clinical_features: [f('conjunctivitis', 0.24), f('nasal_discharge', 0.18), f('sneezing', 0.18)],
        supporting_features: [f('ocular_discharge', 0.16), f('fever', 0.08), f('anorexia', 0.06), f('lethargy', 0.06)],
        exclusion_features: [f('abnormal_lung_sounds', 0.12), f('pneumonia', 0.14), f('poor_oxygenation', 0.12)],
        lab_signatures: [],
        progression_pattern: ['acute', 'subacute'],
        species_relevance: ['cat'],
        zoonotic: false,
    ...
    },
    {
        id: 'fcv-infection',
        name: 'FCV Infection',
        aliases: ['Feline calicivirus infection', 'FCV', 'feline calicivirus'],
        category: 'Cardiopulmonary',
        subcategory: 'Airway',
        condition_class: 'Infectious',
        key_clinical_features: [f('oral_ulceration', 0.24), f('hypersalivation', 0.18), f('sneezing', 0.16)],
        supporting_features: [f('nasal_discharge', 0.16), f('ocular_discharge', 0.12), f('fever', 0.08), f('anorexia', 0.08), f('lethargy', 0.06)],
        exclusion_features: [f('abnormal_lung_sounds', 0.12), f('pneumonia', 0.14), f('poor_oxygenation', 0.12)],
        lab_signatures: [],
        progression_pattern: ['acute', 'subacute'],
        species_relevance: ['cat'],
    ...
    {
        id: 'chlamydophila-associated-uri',
        name: 'Chlamydophila-associated URI',
        aliases: ['Chlamydophila felis URI', 'Chlamydophila felis infection'],
        category: 'Cardiopulmonary',
        subcategory: 'Airway',
        condition_class: 'Infectious',
        key_clinical_features: [f('conjunctivitis', 0.26), f('ocular_discharge', 0.18), f('nasal_discharge', 0.16)],
        supporting_features: [f('sneezing', 0.12), f('fever', 0.06), f('anorexia', 0.05), f('lethargy', 0.05)],
        exclusion_features: [f('abnormal_lung_sounds', 0.12), f('pneumonia', 0.12), f('poor_oxygenation', 0.12)],
        lab_signatures: [],
        progression_pattern: ['acute', 'subacute'],
        species_relevance: ['cat'],
        zoonotic: false,
    ...
    {
        id: 'secondary-bacterial-upper-respiratory-infection',
        name: 'Secondary Bacterial Upper Respiratory Infection',
        aliases: ['secondary bacterial URI'],
        category: 'Cardiopulmonary',
        subcategory: 'Airway',
        condition_class: 'Infectious',
        key_clinical_features: [f('nasal_discharge', 0.22), f('ocular_discharge', 0.14), f('conjunctivitis', 0.14)],
        supporting_features: [f('sneezing', 0.12), f('fever', 0.08), f('anorexia', 0.06), f('lethargy', 0.06)],
        exclusion_features: [f('dyspnea', 0.1), f('tachypnea', 0.1), f('abnormal_lung_sounds', 0.14), f('pneumonia', 0.16), f('poor_oxygenation', 0.14)],
        lab_signatures: [],
        progression_pattern: ['acute', 'subacute'],
        species_relevance: ['cat'],
        zoonotic: false,
    ...
    {
        id: 'feline-bacterial-pneumonia',
        name: 'Feline Bacterial Pneumonia',
        aliases: ['feline pneumonia'],
        category: 'Cardiopulmonary',
        subcategory: 'Parenchymal',
        condition_class: 'Infectious',
        key_clinical_features: [f('dyspnea', 0.2), f('tachypnea', 0.18), f('abnormal_lung_sounds', 0.22)],
        supporting_features: [f('cough', 0.14), f('pneumonia', 0.22), f('thoracic_imaging_abnormality', 0.22), f('poor_oxygenation', 0.18), f('fever', 0.08)],
        exclusion_features: [f('conjunctivitis', 0.12), f('sneezing', 0.12), f('oral_ulceration', 0.12), f('nasal_discharge', 0.08)],
        lab_signatures: [f('thoracic_imaging_abnormality', 0.16), f('poor_oxygenation', 0.14)],
        progression_pattern: ['acute', 'subacute'],
        species_relevance: ['cat'],
        zoonotic: false,
        minimum_feature_match_threshold: 2,
    ...
    {
        id: 'feline-chronic-bronchitis',
        name: 'Feline Chronic Bronchitis',
        aliases: ['feline bronchitis'],
        category: 'Cardiopulmonary',
        subcategory: 'Airway',
        condition_class: 'Degenerative',
        key_clinical_features: [f('cough', 0.22), f('abnormal_lung_sounds', 0.18)],
        supporting_features: [f('dyspnea', 0.1), f('tachypnea', 0.12), f('exercise_intolerance', 0.1)],
        exclusion_features: [f('conjunctivitis', 0.12), f('nasal_discharge', 0.1), f('oral_ulceration', 0.12), f('pneumonia', 0.08)],
        lab_signatures: [],
...
const ANCHOR_LOCK_RULES: AnchorLockRule[] = [
    {
        id: 'feline-uri-anchor',
        label: 'Feline upper respiratory syndrome anchor',
        requires_all: ['sneezing', 'nasal_discharge'],
        required_groups: [
            ['ocular_discharge', 'conjunctivitis', 'oral_ulceration', 'hypersalivation'],
        ],
        anchored_diseases: [
        ...
        protected_categories: ['Cardiopulmonary'],
    },
    {
        id: 'gdv-anchor',
...
const CATEGORY_TRIGGER_TERMS: Record<DiseaseDomain, string[]> = {
    ...
    Cardiopulmonary: ['cough', 'honking_cough', 'sneezing', 'nasal_discharge', 'ocular_discharge', 'conjunctivitis', 'oral_ulceration', 'dyspnea', 'respiratory_distress', 'tachypnea', 'abnormal_lung_sounds', 'orthopnea', 'open_mouth_breathing', 'exercise_intolerance', 'syncope', 'heart_murmur', 'arrhythmia', 'pneumonia', 'thoracic_imaging_abnormality', 'poor_oxygenation', 'pulmonary_edema'],
...
const ORGAN_SYSTEM_RULES: Record<OrganSystem, OrganSystemRule> = {
    ...
    respiratory: {
        ...
        anchorTerms: [
            { term: 'abnormal_lung_sounds', weight: 0.24 },
            ...
            { term: 'thoracic_imaging_abnormality', weight: 0.24 },
            { term: 'poor_oxygenation', weight: 0.2 },
            { term: 'pulmonary_edema', weight: 0.24 },
            { term: 'pleural_effusion', weight: 0.2 },
            { term: 'cyanosis', weight: 0.18 },
        ],
        contextualTerms: [
            { term: 'sneezing', weight: 0.12 },
            { term: 'nasal_discharge', weight: 0.12 },
            { term: 'ocular_discharge', weight: 0.1 },
            { term: 'conjunctivitis', weight: 0.14 },
            { term: 'oral_ulceration', weight: 0.12 },
            { term: 'hypersalivation', weight: 0.08 },
...
const CLINICAL_SYSTEM_RULES: Record<ClinicalSystemDomain, ClinicalSystemRule> = {
    ...
    respiratory: {
        ...
        contextualTerms: [
            ...
            { term: 'ocular_discharge', weight: 0.1 },
            { term: 'conjunctivitis', weight: 0.14 },
            { term: 'oral_ulceration', weight: 0.1 },
            { term: 'hypersalivation', weight: 0.08 },
            { term: 'cough', weight: 0.08 },
            { term: 'exercise_intolerance', weight: 0.08 },
    ...
    infectious: {
        ...
        contextualTerms: [
            { term: 'sneezing', weight: 0.08 },
            { term: 'ocular_discharge', weight: 0.08 },
            { term: 'nasal_discharge', weight: 0.08 },
            { term: 'conjunctivitis', weight: 0.1 },
            { term: 'oral_ulceration', weight: 0.08 },
            { term: 'cough', weight: 0.04 },
            { term: 'diarrhea', weight: 0.04 },
            { term: 'vomiting', weight: 0.04 },
        ],

...
const SIGNAL_TERM_MAP: Record<SignalKey, string> = {
    ...
    dyspnea: 'dyspnea',
    tachypnea: 'tachypnea',
    abnormal_lung_sounds: 'abnormal lung sounds',
    thoracic_imaging_abnormality: 'thoracic imaging abnormality',
    poor_oxygenation: 'poor oxygenation',
    ...
    oral_ulceration: 'oral ulceration',
    pneumonia: 'pneumonia',

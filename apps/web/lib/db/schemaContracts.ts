...
export const TREATMENT_EVENTS = {
    ...
    COLUMNS: {
        ...
        disease: 'disease',
        clinician_confirmed_diagnosis: 'clinician_confirmed_diagnosis',
        diagnosis_source: 'diagnosis_source',
...
export const OAUTH_CLIENTS = {
    ...
    COLUMNS: {
        ...
        assertion_algorithms: 'assertion_algorithms',
        assertion_audiences: 'assertion_audiences',
        assertion_max_ttl_seconds: 'assertion_max_ttl_seconds',
        mtls_required: 'mtls_required',
        mtls_cert_thumbprints: 'mtls_cert_thumbprints',
        mtls_last_thumbprint: 'mtls_last_thumbprint',
        mtls_last_seen_at: 'mtls_last_seen_at',
        metadata: 'metadata',
        created_by: 'created_by',
        revoked_by: 'revoked_by',
        last_used_at: 'last_used_at',
...
export const OAUTH_ACCESS_TOKENS = {
    ...
    COLUMNS: {
        ...
        dpop_last_seen_at: 'dpop_last_seen_at',
        evidence: 'evidence',
        created_at: 'created_at',
    },
} as const;

export const OAUTH_DPOP_PROOF_EVENTS = {
    TABLE: 'oauth_dpop_proof_events',
    COLUMNS: {
        id: 'id',
        tenant_id: 'tenant_id',
        request_id: 'request_id',
...
export const CLINICAL_LEARNING_RECORD_ELIGIBILITY_EVENTS = {
    TABLE: 'clinical_learning_record_eligibility_events',
    COLUMNS: {
        id: 'id',
        tenant_id: 'tenant_id',
        request_id: 'request_id',
        case_id: 'case_id',
        clinical_outcome_id: 'clinical_outcome_id',
        inference_event_id: 'inference_event_id',
        external_validation_event_id: 'external_validation_event_id',
        consent_scope: 'consent_scope',
        consent_status: 'consent_status',
        label_type: 'label_type',
        outcome_confirmation_status: 'outcome_confirmation_status',
        provenance_status: 'provenance_status',
        trust_score: 'trust_score',
        trust_score_components: 'trust_score_components',
        record_hash: 'record_hash',
        eligible_for_federation: 'eligible_for_federation',
...
export const FEDERATED_OUTCOME_ELIGIBILITY_SNAPSHOTS = {
    TABLE: 'federated_outcome_eligibility_snapshots',
    COLUMNS: {
        id: 'id',
        tenant_id: 'tenant_id',
        request_id: 'request_id',
        ...
        lab_confirmed_rows: 'lab_confirmed_rows',
        expert_reviewed_rows: 'expert_reviewed_rows',
        synthetic_rows_excluded: 'synthetic_rows_excluded',
        consented_network_learning_rows: 'consented_network_learning_rows',
        provenance_verified_rows: 'provenance_verified_rows',
        trust_scored_rows: 'trust_scored_rows',
        amr_outcome_linked_rows: 'amr_outcome_linked_rows',
        external_validation_events: 'external_validation_events',
        minimum_required_rows: 'minimum_required_rows',
        minimum_provenance_rows: 'minimum_provenance_rows',
        minimum_trust_scored_rows: 'minimum_trust_scored_rows',
        minimum_external_validations: 'minimum_external_validations',
...
export const FEDERATION_NODE_RUNTIME_EVENTS = {
    TABLE: 'federation_node_runtime_events',
    COLUMNS: {
        id: 'id',
        tenant_id: 'tenant_id',
        request_id: 'request_id',
        ...
        outcome_eligibility_snapshot_id: 'outcome_eligibility_snapshot_id',
        federation_round_id: 'federation_round_id',
        node_kind: 'node_kind',
        ...
        outcome_eligibility_status: 'outcome_eligibility_status',
...
export const FEDERATION_ROUND_NODE_TASKS = {
    ...
    COLUMNS: {
        ...
        secure_aggregation_config: 'secure_aggregation_config',
...
export const FEDERATED_UPDATE_SUBMISSIONS = {
    TABLE: 'federated_update_submissions',
    COLUMNS: {
        id: 'id',
        tenant_id: 'tenant_id',
        request_id: 'request_id',
        federation_round_id: 'federation_round_id',
        round_node_task_id: 'round_node_task_id',
        outcome_eligibility_snapshot_id: 'outcome_eligibility_snapshot_id',
        federation_key: 'federation_key',
        round_key: 'round_key',
        node_ref: 'node_ref',
        ...
        signature_hash: 'signature_hash',
        signing_key_fingerprint: 'signing_key_fingerprint',
        masked_update_summary: 'masked_update_summary',
        public_summary: 'public_summary',
        evidence: 'evidence',
        observed_at: 'observed_at',
        created_at: 'created_at',

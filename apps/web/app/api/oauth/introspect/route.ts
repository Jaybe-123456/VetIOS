...
import { authenticateOAuthClient, introspectOAuthAccessToken } from '@/lib/auth/oauthClientCredentials';
    ...
    try {
        ...
        return withHeaders(
            NextResponse.json({
                ...
                client_id: result.active ? authenticated.client_id : undefined,

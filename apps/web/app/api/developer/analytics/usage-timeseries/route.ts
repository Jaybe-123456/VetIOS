...
import { getUsageTimeseriesForPartner } from '@/lib/api/partner-service';
...
export async function GET(request: Request) {
    ...
    const points = await getUsageTimeseriesForPartner(access.access.client, access.access.partner.id, {

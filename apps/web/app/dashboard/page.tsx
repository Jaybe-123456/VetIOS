        ...
        <Container className="max-w-6xl w-full">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                <ConsoleCard>
                    <div className="flex items-center justify-between mb-2">
                        <span className="font-mono text-xs text-muted uppercase">Inference Throughput</span>
                        <Cpu className="w-4 h-4 text-accent" />
                    </div>
                    <div className="font-mono text-2xl">1,024 <span className="text-xs text-muted">req/s</span></div>
                    <div className="font-mono text-[10px] text-accent mt-2">+12.5% from last hr</div>
                </ConsoleCard>
                <ConsoleCard>
                    <div className="flex items-center justify-between mb-2">
                        <span className="font-mono text-xs text-muted uppercase">Global Accuracy</span>
                        <Activity className="w-4 h-4 text-accent" />
                    </div>
                    <div className="font-mono text-2xl">96.8% <span className="text-xs text-muted">avg</span></div>
                    <div className="font-mono text-[10px] text-muted mt-2">Trailing 24h Window</div>
                </ConsoleCard>
                <ConsoleCard>
                    <div className="flex items-center justify-between mb-2">
                        <span className="font-mono text-xs text-muted uppercase">Active Clinics</span>
                        <Network className="w-4 h-4 text-accent" />
                    </div>
                    <div className="font-mono text-2xl">142 <span className="text-xs text-muted">nodes</span></div>
                    <div className="font-mono text-[10px] text-accent mt-2">3 new initialized</div>
                </ConsoleCard>
                <ConsoleCard>
                    <div className="flex items-center justify-between mb-2">
                        <span className="font-mono text-xs text-muted uppercase">Sim Stress Limit</span>
                        <Database className="w-4 h-4 text-danger" />
                    </div>
                    <div className="font-mono text-2xl text-danger">88.5% <span className="text-xs text-danger/50">cap</span></div>
                    <div className="font-mono text-[10px] text-danger mt-2">Approaching threshold</div>
                </ConsoleCard>
            </div>

            {/* Charts Row */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
                <ConsoleCard title="Network Latency (ms)" className="h-[300px]">
                    <div className="flex-1 -mx-4">
                        <TelemetryChart data={mockLatencyData} dataKey="latency" color="#00ff41" />
                    </div>
                </ConsoleCard>
                <ConsoleCard title="Model Confidence Volatility" className="h-[300px]">
                    <div className="flex-1 -mx-4">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                <div className="lg:col-span-2">
                    <ConsoleCard title="Recent Inferences">
                ...
                <div>
                    <ConsoleCard title="System Alerts">
